const moderatePatientColor="#10739E",seriusPatientColor="#CF8913",criticalPatientColor="#9D443D",skeletonClasses=["skeleton","skeleton-text","skeleton-chart","skeleton-table","skeleton-body","skeleton-w-10","skeleton-w-20","skeleton-w-30","skeleton-w-40","skeleton-w-50","skeleton-w-60","skeleton-w-70","skeleton-w-90","skeleton-w-90","skeleton-w-100"],covid19Severities={moderate:{index:0},serius:{index:1},critical:{index:2}};date.locale("es");let weeklyPatientChartInstance,totalPatientsDoughnutChartInstance,totalPatientLineChartInstance,patientsDataTableInstance;function capitalize(t){return t.charAt(0).toUpperCase()+t.slice(1)}function setDateFormat(t,e){const a=date.format(new Date(t),e);return capitalize(a.replace(".",""))}function setPatientCard(t,e,a){let n=document.getElementById(a+"-label");n.innerHTML=e.label,removeSkeletonClasses(n);var s=document.getElementById(a+"-dropdown-container");let o=document.getElementById(a+"-dropdown-label"),r=document.getElementById(a+"-dropdown-filters");o.innerHTML=t,r.classList.remove("d-none"),removeSkeletonClasses(s);t=document.getElementById(a+"-status-container"),setCoutUp(document.getElementById(a+"-status"),e.total),removeSkeletonClasses(t),s=document.getElementById(a+"-percentage-container");setPatientCardPercentage(a,e.percentage,e.percentage_label),removeSkeletonClasses(s)}function setPatientCardPercentage(t,e,a){const n=document.getElementById(t+"-percentage");0<(e=e.toFixed(0))?(n.innerHTML=`+${e}%`,n.classList.remove("text-success"),n.classList.add("text-danger")):(n.innerHTML=e+"%",n.classList.remove("text-danger"),n.classList.add("text-success")),n.innerHTML+=`<span class="font-weight-normal opacity-8 text-dark" id="moderate-percentage-label"> ${a}</span>`}function createWeeklyPatientsChart(t,e,a,n){var s=document.getElementById("weekly-chart-container"),o=document.getElementById("weekly-patient-chart").getContext("2d");weeklyPatientChartInstance=new Chart(o,{type:"bar",data:{labels:getChartLabels(t.labels),datasets:[{label:e.label,tension:1,borderWidth:0,borderRadius:5,backgroundColor:moderatePatientColor,data:e.data,maxBarThickness:20},{label:a.label,tension:1,borderWidth:0,borderRadius:5,backgroundColor:seriusPatientColor,data:a.data,maxBarThickness:20},{label:n.label,tension:1,borderWidth:0,borderRadius:5,backgroundColor:criticalPatientColor,data:n.data,maxBarThickness:20}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{usePointStyle:!0,pointStyle:"circle"}},scales:{y:{grid:{drawBorder:!1,display:!1,drawOnChartArea:!1,drawTicks:!1},ticks:{display:!1},stacked:!0},x:{grid:{drawBorder:!1,display:!1,drawOnChartArea:!1,drawTicks:!1},ticks:{beginAtZero:!0,font:{size:12,family:"Open Sans",style:"normal"},color:"#9ca2b7"},stacked:!0}}}}),removeSkeletonClasses(s)}function createTotalPatientsDoughnutChart(t){var e=t.data.moderate_patients,a=t.data.serius_patients,n=t.data.critical_patients,s=document.getElementById("total-doughnut-chart-container");const o=document.getElementById("total-patient-doughnut-chart").getContext("2d"),r=o.createLinearGradient(0,230,0,50);var l=document.getElementById("total-doughnut-chart-status");const d=document.getElementById("total-doughnut-chart-label");r.addColorStop(1,"rgba(16, 115, 158,0.2)"),r.addColorStop(.2,"rgba(72,72,176,0.0)"),r.addColorStop(0,"rgba(16, 115, 158,0)"),totalPatientsDoughnutChartInstance=new Chart(o,{type:"doughnut",data:{labels:[e.label,a.label,n.label],datasets:[{weight:10,cutout:90,tension:.9,pointRadius:2,borderWidth:1,borderRadius:5,backgroundColor:[moderatePatientColor,seriusPatientColor,criticalPatientColor],data:[e.total,a.total,n.total],fill:!1}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{usePointStyle:!0,pointStyle:"circle"}},interaction:{intersect:!1,mode:"point"},scales:{y:{grid:{drawBorder:!1,display:!1,drawOnChartArea:!1,drawTicks:!1},ticks:{display:!1}},x:{grid:{drawBorder:!1,display:!1,drawOnChartArea:!1,drawTicks:!1},ticks:{display:!1}}}}}),setCoutUp(l,t.total),d.classList.remove("d-none"),removeSkeletonClasses(s),createTotalTable(e,a,n)}function createTotalTable(t,e,a){var n=document.getElementById("total-table-container");const s=document.getElementById("total-table");s.innerHTML+=`
    ...
    `,removeSkeletonClasses(n)}function createTotalPatientsLineChart(t){var e=t.data.moderate_patients,a=t.data.serius_patients,n=t.data.critical_patients,s=document.getElementById("total-line-chart-status");const o=document.getElementById("total-line-chart-label");var r=document.getElementById("total-line-chart-label-container");const l=document.getElementById("total-line-badges"),d=document.getElementById("total-line-chart-percentage");setCoutUp(s,t.total),o.classList.remove("d-none"),d.innerHTML=setTotalPatientPercentage(t.total_percentage),setLegendTotalPatientLineChart("moderate",e.label),setLegendTotalPatientLineChart("serius",a.label),setLegendTotalPatientLineChart("critical",n.label),l.classList.add("mb-1"),constructTotalPatientLineChart(t.labels,e,a,n),removeSkeletonClasses(s),removeSkeletonClasses(r),removeSkeletonClasses(d)}function setTotalPatientPercentage(t){return 0<=(t=t.toFixed(0))?`
    ...
    `}function setDatatablePlugin(){patientsDataTableInstance=new simpleDatatables.DataTable("#datatable-patients")}function setCoutUp(t,e){if(t.setAttribute("countTo",e),t){const a=new CountUp(t,t.getAttribute("countTo"));a.error||a.start()}}function initializeTooltips(){const t=[].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]'));t.map(function(t){return new bootstrap.Tooltip(t,{})})}function removeSkeletonClasses(t){t.classList.remove(...skeletonClasses)}function aosInit(){AOS.init({duration:1e3,easing:"ease-in-out",once:!1,mirror:!1})}function errorAlert(){Swal.fire({icon:"error",title:"Error al procesar la solicitud",text:"Intente nuevamente por favor!",confirmButtonText:"Aceptar",timer:3e3,timerProgressBar:!0})}function setCardDate(t,e){return e=setDateFormat((new Date).toDateString(),"MM/DD/YYYY")===e?(t=setDateFormat(t,"DD de MMMM"),"Hoy"):(t=setDateFormat(t,"DD de MMM"),setDateFormat(e,"DD de MMM")),t+" - "+e}function getInitialData(){$.ajax({url:"/initial-dashboard-data",type:"GET",success:t=>{var e=t.weekly_ranking,a=t.annual_ranking,n=t.total_ranking,t=t.summary,s=setCardDate(e.start_date,e.end_date),o=e.data.moderate_patients,r=e.data.serius_patients,l=e.data.critical_patients;setPatientCard(s,o,"moderate"),setPatientCard(s,r,"serius"),setPatientCard(s,l,"critical"),createWeeklyPatientsChart(e,o,r,l),createTotalPatientsDoughnutChart(n),createTotalPatientsLineChart(a),createSummaryTable(t),initializeTooltips()},error:()=>{window.location.href="/internal-error"}})}function addSkeletonClasses(t,e){t.classList.add(...e)}function addCardSkeletonClasses(t){var e=document.getElementById(t+"-dropdown-container");let a=document.getElementById(t+"-dropdown-filters");addSkeletonClasses(e,["skeleton","skeleton-text","skeleton-w-30"]);e=document.getElementById(t+"-status-container");let n=document.getElementById(t+"-status");n.innerText=0,addSkeletonClasses(e,["skeleton","skeleton-text","skeleton-w-20"]);e=document.getElementById(t+"-percentage-container");(percentageStatus=document.getElementById(t+"-percentage")).innerText="",addSkeletonClasses(e,["skeleton","skeleton-text","skeleton-w-40"]),a.classList.add("d-none")}function queryPatientCard(e){$.ajax({url:"/filter-patient-card",type:"GET",data:e,beforeSend:()=>{addCardSkeletonClasses(e.covid19Severity)},success:t=>{setPatientCard(setCardDate(t.start_date,t.end_date),t.data.patients,e.covid19Severity)},error:()=>{errorAlert()}})}let dropDownsCardSelected={moderate:{covid19Severity:"moderate",dateRange:"lastSevenDays"},serius:{covid19Severity:"serius",dateRange:"lastSevenDays"},critical:{covid19Severity:"serius",dateRange:"lastSevenDays"}};const dropDownOptions=document.querySelectorAll("#moderate-dropdown-options li a, #serius-dropdown-options li a, #critical-dropdown-options li a");function addTotalLineSkeletonClasses(){let t=document.getElementById("total-line-chart-status"),e=(t.innerText="",addSkeletonClasses(t,["skeleton","skeleton-text","skeleton-w-20"]),document.getElementById("total-line-chart-label"));e.classList.add("d-none"),addSkeletonClasses(document.getElementById("total-line-chart-label-container"),["skeleton","skeleton-text","skeleton-w-30"]);let a=document.getElementById("total-line-chart-percentage");a.innerText="",addSkeletonClasses(a,["skeleton","skeleton-text","skeleton-w-50"]),addSkeletonClasses(document.getElementById("total-line-chart-container"),["skeleton","skeleton-chart"])}function queryTotalPatientLineChart(t){$.ajax({url:"/filter-total-line-chart",type:"GET",data:t,beforeSend:()=>{destroyChart(totalPatientLineChartInstance),addTotalLineSkeletonClasses()},success:t=>{createTotalPatientsLineChart(t.ranking)},error:()=>{errorAlert()}})}function resetTotalPatientLineChart(){dates=[],queryTotalPatientLineChart({startDate:setDateFormat(new Date,"DD-MMM-YYYY")})}dropDownOptions.forEach(a=>{a.addEventListener("click",()=>{var t=a.getAttribute("data-severity"),e={covid19Severity:t,dateRange:a.getAttribute("date-range")};queryPatientCard(dropDownsCardSelected[t]=e)})});var totalLineChartDates=null;function clearDatePicker(){document.querySelector(".datepicker")._flatpickr.clear(),resetTotalPatientLineChart()}function querySummaryTable(t){$.ajax({url:"/filter-summary-table",type:"GET",data:t,success:t=>{createSummaryTable(t.summary)},error:()=>{errorAlert()}})}document.querySelector(".datepicker")&&flatpickr(".datepicker",{mode:"range",locale:"es",dateFormat:"d M Y",maxDate:new Date,onChange:t=>{var e;2===t.length&&(e=setDateFormat(t[0],"MM-DD-YYYY"),t=setDateFormat(t[1],"MM-DD-YYYY"),totalLineChartDates=e===t?(clearDatePicker(),null):(queryTotalPatientLineChart(e={startDate:e,endDate:t}),e))},onClose:t=>{1===t.length&&(resetTotalPatientLineChart(),totalLineChartDates=null)}}),document.getElementById("clear-date").addEventListener("click",()=>{clearDatePicker()});let dropDownsSummaryTableSelected={selected:{covid19Severity:"all"}};const summaryDropDownOptions=document.querySelectorAll("#dropdown-table-options li a");function addSumaryTableSkeletonClasses(){document.getElementById("datatable-patients").classList.add("d-none"),document.getElementsByClassName("dataTable-top")[0].classList.add("d-none"),document.getElementsByClassName("dataTable-bottom")[0].classList.add("d-none"),addSkeletonClasses(document.getElementById("datatable-patients-container"),["skeleton","skeleton-table"])}function updateCardPatient(n,s){let t=dropDownsCardSelected[s];var o=t.dateRange.toLowerCase();if("lastweek"!==o){var r=document.getElementById(s+"-status");let t=0,e=0,a="";"lastsevendays"===o&&(t=n.weekly_ranking.data.patients.total,e=n.weekly_ranking.data.patients.percentage,a=n.weekly_ranking.data.patients.percentage_label),"lastmonth"===o&&(t=n.monthly_ranking.data.patients.total,e=n.monthly_ranking.data.patients.percentage,a=n.monthly_ranking.data.patients.percentage_label),setCoutUp(r,t),setPatientCardPercentage(s,e,a)}}function checkDateExists(t,e){return t.data.labels.indexOf(e)}function getCovid19SeverityIndex(t){return covid19Severities[t].index}function updateWeeklyPatientsChart(t,e){var e=getChartLabels([e])[0],t=getCovid19SeverityIndex(t),a=checkDateExists(weeklyPatientChartInstance,e);-1===a?(weeklyPatientChartInstance.data.labels.push(e),weeklyPatientChartInstance.data.datasets[t].data.push(1)):(e=weeklyPatientChartInstance.data.datasets[t].data[a]||0,weeklyPatientChartInstance.data.datasets[t].data[a]=e+1),weeklyPatientChartInstance.update()}function updateTotalPatientsDoughnutChart(t,e){var a=getCovid19SeverityIndex(e),n=document.getElementById("total-doughnut-chart-status"),s=totalPatientsDoughnutChartInstance.data.datasets[0].data[a]||0;let o=document.getElementById(`donut-${e}-status`);setCoutUp(n,t.total),totalPatientsDoughnutChartInstance.data.datasets[0].data[a]=s+1,totalPatientsDoughnutChartInstance.update(),o.innerText=+o.innerText+1}function updateTotalPatientsLineChart(e,a,n){if(!totalLineChartDates){var s=document.getElementById("total-line-chart-status");let t=document.getElementById("total-line-chart-percentage");var n=getChartLabels([n])[0],a=getCovid19SeverityIndex(a),o=checkDateExists(totalPatientLineChartInstance,n);setCoutUp(s,e.total),t.innerHTML=setTotalPatientPercentage(e.total_percentage),-1===o?(totalPatientLineChartInstance.data.labels.push(n),totalPatientLineChartInstance.data.datasets[a].data.push(1)):(s=totalPatientLineChartInstance.data.datasets[a].data[o]||0,totalPatientLineChartInstance.data.datasets[a].data[o]=s+1),totalPatientLineChartInstance.update()}}function updateSummaryTable(){querySummaryTable(dropDownsSummaryTableSelected.selected)}summaryDropDownOptions.forEach(e=>{e.addEventListener("click",()=>{var t={covid19Severity:e.getAttribute("data-severity")};dropDownsSummaryTableSelected.selected=t,addSumaryTableSkeletonClasses(),querySummaryTable(t)})});var socket=io.connect("https://dashboard-microservice.herokuapp.com",{forceNew:!0});socket.on("patient",t=>{updateCardPatient(t,t.type_of_patient),updateWeeklyPatientsChart(t.type_of_patient,t.large_date),updateTotalPatientsDoughnutChart(t.total_ranking,t.type_of_patient),updateTotalPatientsLineChart(t.annual_ranking,t.type_of_patient,t.short_date),updateSummaryTable(dropDownsSummaryTableSelected.selected)}),window.addEventListener("load",()=>{aosInit(),getInitialData()});