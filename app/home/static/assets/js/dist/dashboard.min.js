const moderatePatientColor="#10739E",seriusPatientColor="#CF8913",criticalPatientColor="#9D443D";let skeletonClasses=["skeleton","skeleton-text","skeleton-chart","skeleton-table","skeleton-body","skeleton-w-10","skeleton-w-20","skeleton-w-30","skeleton-w-40","skeleton-w-50","skeleton-w-60","skeleton-w-70","skeleton-w-90","skeleton-w-90","skeleton-w-100"];function capitalize(t){return t.charAt(0).toUpperCase()+t.slice(1)}function setDateFormat(t,e){const a=date.format(new Date(t),e);return capitalize(a.replace(".",""))}function setPatientCard(t,e,a){const o=document.getElementById(a+"-label");o.innerHTML=e.label,removeSkeletonClasses(o);var n=document.getElementById(a+"-dropdown-container");const r=document.getElementById(a+"-dropdown-label"),s=document.getElementById(a+"-dropdown-filters");r.innerHTML=t,s.classList.remove("d-none"),removeSkeletonClasses(n);t=document.getElementById(a+"-status-container"),setCoutUp(document.getElementById(a+"-status"),e.total),removeSkeletonClasses(t),n=document.getElementById(a+"-percentage-container");setPatientCardPercentage(a,e.percentage,e.percentage_label),removeSkeletonClasses(n)}function setPatientCardPercentage(t,e,a){const o=document.getElementById(t+"-percentage");0<(e=e.toFixed(0))?(o.innerHTML=`+${e}%`,o.classList.remove("text-success"),o.classList.add("text-danger")):(o.innerHTML=e+"%",o.classList.remove("text-danger"),o.classList.add("text-success")),o.innerHTML+=`<span class="font-weight-normal opacity-8 text-dark" id="moderate-percentage-label"> ${a}</span>`}function createWeeklyPatientsChart(t,e,a,o){var n=document.getElementById("weekly-chart-container"),r=document.getElementById("weekly-patient-chart").getContext("2d");new Chart(r,{type:"bar",data:{labels:t.labels,datasets:[{label:e.label,tension:1,borderWidth:0,borderRadius:5,backgroundColor:moderatePatientColor,data:e.data,maxBarThickness:20},{label:a.label,tension:1,borderWidth:0,borderRadius:5,backgroundColor:seriusPatientColor,data:a.data,maxBarThickness:20},{label:o.label,tension:1,borderWidth:0,borderRadius:5,backgroundColor:criticalPatientColor,data:o.data,maxBarThickness:20}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{usePointStyle:!0,pointStyle:"circle"}},scales:{y:{grid:{drawBorder:!1,display:!1,drawOnChartArea:!1,drawTicks:!1},ticks:{display:!1},stacked:!0},x:{grid:{drawBorder:!1,display:!1,drawOnChartArea:!1,drawTicks:!1},ticks:{beginAtZero:!0,font:{size:12,family:"Open Sans",style:"normal"},color:"#9ca2b7"},stacked:!0}}}}),removeSkeletonClasses(n)}function createTotalPatientsDoughnutChart(t){var e=t.data.moderate_patients,a=t.data.serius_patients,o=t.data.critical_patients,n=document.getElementById("total-doughnut-chart-container");const r=document.getElementById("total-patient-doughnut-chart").getContext("2d"),s=r.createLinearGradient(0,230,0,50);var l=document.getElementById("total-doughnut-chart-status");const d=document.getElementById("total-doughnut-chart-label");s.addColorStop(1,"rgba(16, 115, 158,0.2)"),s.addColorStop(.2,"rgba(72,72,176,0.0)"),s.addColorStop(0,"rgba(16, 115, 158,0)"),new Chart(r,{type:"doughnut",data:{labels:[e.label,a.label,o.label],datasets:[{weight:10,cutout:90,tension:.9,pointRadius:2,borderWidth:1,borderRadius:5,backgroundColor:[moderatePatientColor,seriusPatientColor,criticalPatientColor],data:[e.total,a.total,o.total],fill:!1}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{usePointStyle:!0,pointStyle:"circle"}},interaction:{intersect:!1,mode:"point"},scales:{y:{grid:{drawBorder:!1,display:!1,drawOnChartArea:!1,drawTicks:!1},ticks:{display:!1}},x:{grid:{drawBorder:!1,display:!1,drawOnChartArea:!1,drawTicks:!1},ticks:{display:!1}}}}}),setCoutUp(l,t.total),d.classList.remove("d-none"),removeSkeletonClasses(n),createTotalTable(e,a,o)}function createTotalTable(t,e,a){var o=document.getElementById("total-table-container");const n=document.getElementById("total-table");n.innerHTML+=`
        <tbody>
            <tr>
                <td>
    ...
    `,removeSkeletonClasses(o)}function createTotalPatientsLineChart(t){var e=t.data.moderate_patients,a=t.data.serius_patients,o=t.data.critical_patients,n=document.getElementById("total-line-chart-status");const r=document.getElementById("total-line-chart-label"),s=document.getElementById("total-line-chart-percentage");setCoutUp(n,t.total),r.classList.remove("d-none"),s.innerHTML+=setTotalPatientPercentage(t.total_percentage),setLegendTotalPatientLineChart("moderate",e.label),setLegendTotalPatientLineChart("serius",a.label),setLegendTotalPatientLineChart("critical",o.label),constructTotalPatientLineChart(t.labels,e,a,o),removeSkeletonClasses(n),removeSkeletonClasses(r),removeSkeletonClasses(s)}function setTotalPatientPercentage(t){return 0<=(t=t.toFixed(0))?`
    ...
    `,removeSkeletonClasses(a)}function constructTotalPatientLineChart(t,e,a,o){var n=document.getElementById("total-line-chart-container");const r=document.getElementById("total-line-chart").getContext("2d"),s=r.createLinearGradient(0,230,0,50),l=r.createLinearGradient(0,230,0,50),d=r.createLinearGradient(0,230,0,50);s.addColorStop(1,"rgba(23, 194, 232, 0.2)"),s.addColorStop(.2,"rgba(72,72,176,0.0)"),s.addColorStop(0,"rgba(23, 194, 232,0)"),l.addColorStop(1,"rgba(58, 65, 111,0.2)"),l.addColorStop(.2,"rgba(72,72,176,0.0)"),l.addColorStop(0,"rgba(58, 65, 111,0)"),d.addColorStop(1,"rgba(203, 12, 159,0.2)"),d.addColorStop(.2,"rgba(72,72,176,0.0)"),d.addColorStop(0,"rgba(203, 12, 159,0)"),new Chart(r,{type:"line",data:{labels:t,datasets:[{label:e.label,tension:.4,borderWidth:0,pointRadius:2,pointBackgroundColor:moderatePatientColor,borderColor:moderatePatientColor,backgroundColor:s,fill:!0,data:e.data,maxBarThickness:6},{label:a.label,tension:.4,pointRadius:2,pointBackgroundColor:seriusPatientColor,borderColor:seriusPatientColor,borderWidth:3,backgroundColor:l,fill:!0,data:a.data,maxBarThickness:6},{label:o.label,tension:.4,pointRadius:2,pointBackgroundColor:criticalPatientColor,borderColor:criticalPatientColor,borderWidth:3,backgroundColor:d,fill:!0,data:o.data,maxBarThickness:6}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{usePointStyle:!0,pointStyle:"circle",position:"nearest"}},interaction:{mode:"index"},scales:{y:{grid:{drawBorder:!1,display:!1,drawOnChartArea:!1,drawTicks:!1},ticks:{display:!1}},x:{grid:{drawBorder:!1,display:!1,drawOnChartArea:!1,drawTicks:!1},ticks:{beginAtZero:!0,font:{size:12,family:"Open Sans",style:"normal"},color:"#9ca2b7"}}}}}),removeSkeletonClasses(n)}function createSummaryTable(t){var e=document.getElementById("datatable-patients-container");const a=document.getElementById("datatable-patients");t=setTbodySummaryTable(t.patients,"DD MMM YYYY");a.innerHTML+=`
        <tbody>
            ${t}
        </tbody>
    ...
    `}function setDatatablePlugin(){new simpleDatatables.DataTable("#datatable-patients")}function setCoutUp(t,e){if(t.setAttribute("countTo",e),t){const a=new CountUp(t,t.getAttribute("countTo"));a.error?console.error(a.error):a.start()}}function initializeTooltips(){const t=[].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]'));t.map(function(t){return new bootstrap.Tooltip(t,{})})}function removeSkeletonClasses(t){t.classList.remove(...skeletonClasses)}function aosInit(){AOS.init({duration:1e3,easing:"ease-in-out",once:!1,mirror:!1})}function errorAlert(){Swal.fire({icon:"error",title:"Error al procesar la solicitud",text:"Intente nuevamente por favor!",confirmButtonText:"Aceptar",timer:3e3,timerProgressBar:!0})}function setCardDate(t,e){return e=setDateFormat((new Date).toDateString(),"MM/DD/YYYY")===e?(t=setDateFormat(t,"DD de MMMM"),"Hoy"):(t=setDateFormat(t,"DD de MMM"),setDateFormat(e,"DD de MMM")),t+" - "+e}function getInitialData(){$.ajax({url:"/initial-dashboard-data",type:"GET",success:t=>{var e=t.weekly_ranking,a=t.annual_ranking,o=t.total_ranking,t=t.summary,n=setCardDate(e.start_date,e.end_date),r=e.data.moderate_patients,s=e.data.serius_patients,l=e.data.critical_patients;setPatientCard(n,r,"moderate"),setPatientCard(n,s,"serius"),setPatientCard(n,l,"critical"),createWeeklyPatientsChart(e,r,s,l),createTotalPatientsDoughnutChart(o),createTotalPatientsLineChart(a),createSummaryTable(t),initializeTooltips()},error:()=>{window.location.href="/internal-error"}})}function queryPatientCard(e){$.ajax({url:"/filter-patient-card",type:"GET",data:e,success:t=>{setPatientCard(setCardDate(t.start_date,t.end_date),t.data.patients,e.covid19Severity)},error:()=>{errorAlert()}})}date.locale("es");const dropDownOptions=document.querySelectorAll("#moderate-dropdown-options li a, #serius-dropdown-options li a, #critical-dropdown-options li a");function queryTotalPatientLineChart(t){$.ajax({url:"/filter-total-line-chart",type:"GET",data:t,success:t=>{console.log(t)},error:()=>{errorAlert()}})}function querySummaryTable(t){$.ajax({url:"/filter-summary-table",type:"GET",data:t,success:t=>{console.log(t)},error:()=>{errorAlert()}})}dropDownOptions.forEach(t=>{t.addEventListener("click",()=>{queryPatientCard({covid19Severity:t.getAttribute("data-severity"),dateRange:t.getAttribute("date-range")})})}),document.querySelector(".datepicker")&&flatpickr(".datepicker",{mode:"range",locale:"es",dateFormat:"d M Y",onChange:t=>{2===t.length&&queryTotalPatientLineChart({startDate:setDateFormat(t[0],"DD-MMM-YYYY"),endDate:setDateFormat(t[1],"DD-MMM-YYYY")})},onClose:t=>{t.length<2&&console.log("Datos iniciales")}});const summaryDropDownOptions=document.querySelectorAll("#dropdown-table-options li a");summaryDropDownOptions.forEach(t=>{t.addEventListener("click",()=>{querySummaryTable({covid19Severity:t.getAttribute("data-severity")})})}),window.addEventListener("load",()=>{aosInit(),getInitialData()});