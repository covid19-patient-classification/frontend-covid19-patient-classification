const moderatePatientColor="#10739E",seriusPatientColor="#CF8913",criticalPatientColor="#9D443D",skeletonClasses=["skeleton","skeleton-text","skeleton-chart","skeleton-table","skeleton-body","skeleton-w-10","skeleton-w-20","skeleton-w-30","skeleton-w-40","skeleton-w-50","skeleton-w-60","skeleton-w-70","skeleton-w-90","skeleton-w-90","skeleton-w-100"],covid19Severities={moderate:{index:0},serius:{index:1},critical:{index:2}};date.locale("es");let weeklyPatientChartInstance,totalPatientsDoughnutChartInstance,totalPatientLineChartInstance,patientsDataTableInstance;function capitalize(t){return t.charAt(0).toUpperCase()+t.slice(1)}function setDateFormat(t,e){let a=date.format(new Date(t),e);return capitalize(a.replace(".",""))}function setPatientCard(t,e,a){let n=document.getElementById(a+"-label");n.innerHTML=e.label,removeSkeletonClasses(n);var o=document.getElementById(a+"-dropdown-container");let r=document.getElementById(a+"-dropdown-label"),s=document.getElementById(a+"-dropdown-filters");r.innerHTML=t,s.classList.remove("d-none"),removeSkeletonClasses(o);t=document.getElementById(a+"-status-container"),setCoutUp(document.getElementById(a+"-status"),e.total),removeSkeletonClasses(t),o=document.getElementById(a+"-percentage-container");setPatientCardPercentage(a,e.percentage,e.percentage_label),removeSkeletonClasses(o)}function setPatientCardPercentage(t,e,a){let n=document.getElementById(t+"-percentage");0<(e=e.toFixed(0))?(n.innerHTML=`+${e}%`,n.classList.remove("text-success"),n.classList.add("text-danger")):(n.innerHTML=e+"%",n.classList.remove("text-danger"),n.classList.add("text-success")),n.innerHTML+=`<span class="font-weight-normal opacity-8 text-dark" id="moderate-percentage-label"> ${a}</span>`}function createWeeklyPatientsChart(t,e,a,n){let o=document.getElementById("weekly-chart-container");var r=document.getElementById("weekly-patient-chart").getContext("2d");weeklyPatientChartInstance=new Chart(r,{type:"bar",data:{labels:getChartLabels(t.labels),datasets:[{label:e.label,tension:1,borderWidth:0,borderRadius:5,backgroundColor:moderatePatientColor,data:e.data,maxBarThickness:20},{label:a.label,tension:1,borderWidth:0,borderRadius:5,backgroundColor:seriusPatientColor,data:a.data,maxBarThickness:20},{label:n.label,tension:1,borderWidth:0,borderRadius:5,backgroundColor:criticalPatientColor,data:n.data,maxBarThickness:20}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{usePointStyle:!0,pointStyle:"circle"}},scales:{y:{grid:{drawBorder:!1,display:!1,drawOnChartArea:!1,drawTicks:!1},ticks:{display:!1},stacked:!0},x:{grid:{drawBorder:!1,display:!1,drawOnChartArea:!1,drawTicks:!1},ticks:{beginAtZero:!0,font:{size:12,family:"Open Sans",style:"normal"},color:"#9ca2b7"},stacked:!0}}}}),removeSkeletonClasses(o),o.classList.add("mt-4")}function createTotalPatientsDoughnutChart(t){var e=t.data.moderate_patients,a=t.data.serius_patients,n=t.data.critical_patients,o=document.getElementById("total-doughnut-chart-container");let r=document.getElementById("total-patient-doughnut-chart").getContext("2d"),s=r.createLinearGradient(0,230,0,50);var l=document.getElementById("total-doughnut-chart-status");let d=document.getElementById("total-doughnut-chart-label");s.addColorStop(1,"rgba(16, 115, 158,0.2)"),s.addColorStop(.2,"rgba(72,72,176,0.0)"),s.addColorStop(0,"rgba(16, 115, 158,0)"),totalPatientsDoughnutChartInstance=new Chart(r,{type:"doughnut",data:{labels:[e.label,a.label,n.label],datasets:[{weight:10,cutout:90,tension:.9,pointRadius:2,borderWidth:1,borderRadius:5,backgroundColor:[moderatePatientColor,seriusPatientColor,criticalPatientColor],data:[e.total,a.total,n.total],fill:!1}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{usePointStyle:!0,pointStyle:"circle"}},interaction:{intersect:!1,mode:"point"},scales:{y:{grid:{drawBorder:!1,display:!1,drawOnChartArea:!1,drawTicks:!1},ticks:{display:!1}},x:{grid:{drawBorder:!1,display:!1,drawOnChartArea:!1,drawTicks:!1},ticks:{display:!1}}}}}),setCoutUp(l,t.total),d.classList.remove("d-none"),removeSkeletonClasses(o),createTotalTable(e,a,n)}function changeTableMargin(t){window.matchMedia("(min-width: 500px)").matches&&(t.classList.remove("mt-5"),t.classList.add("total-table"))}function createTotalTable(t,e,a){var n=document.getElementById("total-table-container");let o=document.getElementById("total-table");o.innerHTML+=`
    ...
    `,removeSkeletonClasses(n),changeTableMargin(n)}function add(t,e){return t+e}function createTotalPatientsLineChart(t){var e=t.data.moderate_patients,a=t.data.serius_patients,n=t.data.critical_patients,o=document.getElementById("total-line-chart-status");let r=document.getElementById("total-line-chart-label");var s=document.getElementById("total-line-chart-label-container");let l=document.getElementById("total-line-badges"),d=document.getElementById("total-line-chart-percentage");setCoutUp(o,t.total),r.classList.remove("d-none"),d.innerHTML=setTotalPatientPercentage(t.total_percentage),setLegendTotalPatientLineChart("moderate",e.label),setLegendTotalPatientLineChart("serius",a.label),setLegendTotalPatientLineChart("critical",n.label),l.classList.add("mb-1"),constructTotalPatientLineChart(t.labels,e,a,n),removeSkeletonClasses(o),removeSkeletonClasses(s),removeSkeletonClasses(d)}function setTotalPatientPercentage(t){return 0<=(t=t.toFixed(0))?`
        ...
        `:`
            ...
            <span class="text-secondary text-sm ms-2">en <strong>${(new Date).getFullYear()}</strong></span>
        `}function setLegendTotalPatientLineChart(t,e){let a=document.getElementById(`total-line-${t}-badge`);a.innerHTML=`
        <i class="${t}-bg"></i>
        <span class="text-dark text-xs">${e}</span>
    `,removeSkeletonClasses(a)}function validateDate(t){var e=(new Date).getFullYear().toString();return t.includes(e)}function getChartLabels(t){if(t.every(validateDate)){let e=(new Date).getFullYear().toString();return let=labels=[],t.map(t=>{t.includes(e)&&labels.push(t.replace(" "+e,""))}),labels}return t}function destroyChart(t){t&&t.destroy()}function isEmpyData(t){return 0===t.reduce(add,0)}function warningAlert(){Swal.fire({icon:"warning",title:"Datos de pacientes no encontrados",text:"No se encontraron datos en el rango de fechas especificadas",confirmButtonText:"Aceptar",timer:5e3,timerProgressBar:!0})}function constructTotalPatientLineChart(o,r,s,l){var t=document.getElementById("total-line-chart-container");if(isEmpyData(r.data)&&isEmpyData(s.data)&&isEmpyData(l.data))warningAlert();else{let t=document.getElementById("total-line-chart").getContext("2d"),e=t.createLinearGradient(0,230,0,50),a=t.createLinearGradient(0,230,0,50),n=t.createLinearGradient(0,230,0,50);e.addColorStop(1,"rgba(23, 194, 232, 0.2)"),e.addColorStop(.2,"rgba(72,72,176,0.0)"),e.addColorStop(0,"rgba(23, 194, 232,0)"),a.addColorStop(1,"rgba(58, 65, 111,0.2)"),a.addColorStop(.2,"rgba(72,72,176,0.0)"),a.addColorStop(0,"rgba(58, 65, 111,0)"),n.addColorStop(1,"rgba(203, 12, 159,0.2)"),n.addColorStop(.2,"rgba(72,72,176,0.0)"),n.addColorStop(0,"rgba(203, 12, 159,0)"),totalPatientLineChartInstance=new Chart(t,{type:"line",data:{labels:getChartLabels(o),datasets:[{label:r.label,tension:.4,pointRadius:2,pointBackgroundColor:moderatePatientColor,borderColor:moderatePatientColor,backgroundColor:e,borderWidth:3,fill:!0,data:r.data,maxBarThickness:6},{label:s.label,tension:.4,pointRadius:2,pointBackgroundColor:seriusPatientColor,borderColor:seriusPatientColor,backgroundColor:a,borderWidth:3,fill:!0,data:s.data,maxBarThickness:6},{label:l.label,tension:.4,pointRadius:2,pointBackgroundColor:criticalPatientColor,borderColor:criticalPatientColor,backgroundColor:n,borderWidth:3,fill:!0,data:l.data,maxBarThickness:6}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{usePointStyle:!0,pointStyle:"circle",position:"nearest"}},interaction:{mode:"index"},scales:{y:{grid:{drawBorder:!1,display:!1,drawOnChartArea:!1,drawTicks:!1},ticks:{display:!1}},x:{grid:{drawBorder:!1,display:!1,drawOnChartArea:!1,drawTicks:!1},ticks:{beginAtZero:!0,font:{size:12,family:"Open Sans",style:"normal"},color:"#9ca2b7"}}}}})}removeSkeletonClasses(t)}function clearPatientDataTable(t){patientsDataTableInstance.clear(),patientsDataTableInstance.destroy(),t.removeChild(t.getElementsByTagName("tbody")[0])}function createSummaryTable(t){var e=document.getElementById("datatable-patients-container");let a=document.getElementById("datatable-patients");t=setTbodySummaryTable(t.patients);patientsDataTableInstance&&clearPatientDataTable(a),a.innerHTML+=`
        <tbody>
            ${t}
        </tbody>
    `,a.classList.remove("d-none"),removeSkeletonClasses(e),setDatatablePlugin()}function protectIdentification(e){let a="";for(let t=0;t<e.length;t++)0===t||1===t||7<=t?a+=e[t]:a+="X";return a}function protectName(){let e="";for(let t=0;t<10;t++)e+="x";return capitalize(e)}function addTrSummaryTable(t){return`
        <tr>
            <td class="text-sm text-dark fw-bolder">${protectIdentification(t.identification)}</td>
