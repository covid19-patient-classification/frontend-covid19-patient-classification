window.addEventListener("load",()=>{aosInit(),getInitialData()});const moderatePatientColor="#10739E",seriusPatientColor="#CF8913",criticalPatientColor="#9D443D";let skeletonClasses=["skeleton","skeleton-text","skeleton-chart","skeleton-table","skeleton-body","skeleton-w-10","skeleton-w-20","skeleton-w-30","skeleton-w-40","skeleton-w-50","skeleton-w-60","skeleton-w-70","skeleton-w-90","skeleton-w-90","skeleton-w-100"];function setPatientCard(t,e,a){const o=document.getElementById(a+"-label");o.innerHTML=e.label,removeSkeletonClasses(o);var n=document.getElementById(a+"-dropdown-container");const s=document.getElementById(a+"-dropdown-label"),l=document.getElementById(a+"-dropdown-filters");s.innerHTML=t,l.classList.remove("d-none"),removeSkeletonClasses(n);t=document.getElementById(a+"-status-container"),setCoutUp(document.getElementById(a+"-status"),e.total),removeSkeletonClasses(t),n=document.getElementById(a+"-percentage-container");setPatientCardPercentage(a,e.percentage,e.percentage_label),removeSkeletonClasses(n)}function setPatientCardPercentage(t,e,a){const o=document.getElementById(t+"-percentage");0<=e?(o.innerHTML=`+${e}%`,o.classList.add("text-danger")):(o.innerHTML=e+"%",o.classList.add("text-success")),o.innerHTML+=`<span class="font-weight-normal opacity-8 text-dark" id="moderate-percentage-label"> ${a}</span>`}function createWeeklyPatientsChart(t,e,a,o){var n=document.getElementById("weekly-chart-container"),s=document.getElementById("weekly-patient-chart").getContext("2d");new Chart(s,{type:"bar",data:{labels:t.labels,datasets:[{label:e.label,tension:1,borderWidth:0,borderRadius:5,backgroundColor:moderatePatientColor,data:e.data,maxBarThickness:20},{label:a.label,tension:1,borderWidth:0,borderRadius:5,backgroundColor:seriusPatientColor,data:a.data,maxBarThickness:20},{label:o.label,tension:1,borderWidth:0,borderRadius:5,backgroundColor:criticalPatientColor,data:o.data,maxBarThickness:20}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{usePointStyle:!0,pointStyle:"circle"}},scales:{y:{grid:{drawBorder:!1,display:!1,drawOnChartArea:!1,drawTicks:!1},ticks:{display:!1},stacked:!0},x:{grid:{drawBorder:!1,display:!1,drawOnChartArea:!1,drawTicks:!1},ticks:{beginAtZero:!0,font:{size:12,family:"Open Sans",style:"normal"},color:"#9ca2b7"},stacked:!0}}}}),removeSkeletonClasses(n)}function createTotalPatientsDoughnutChart(t){var e=t.data.moderate_patients,a=t.data.serius_patients,o=t.data.critical_patients,n=document.getElementById("total-doughnut-chart-container");const s=document.getElementById("total-patient-doughnut-chart").getContext("2d"),l=s.createLinearGradient(0,230,0,50);var r=document.getElementById("total-doughnut-chart-status");const d=document.getElementById("total-doughnut-chart-label");l.addColorStop(1,"rgba(16, 115, 158,0.2)"),l.addColorStop(.2,"rgba(72,72,176,0.0)"),l.addColorStop(0,"rgba(16, 115, 158,0)"),new Chart(s,{type:"doughnut",data:{labels:[e.label,a.label,o.label],datasets:[{weight:10,cutout:90,tension:.9,pointRadius:2,borderWidth:1,borderRadius:5,backgroundColor:[moderatePatientColor,seriusPatientColor,criticalPatientColor],data:[e.total,a.total,o.total],fill:!1}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{usePointStyle:!0,pointStyle:"circle"}},interaction:{intersect:!1,mode:"point"},scales:{y:{grid:{drawBorder:!1,display:!1,drawOnChartArea:!1,drawTicks:!1},ticks:{display:!1}},x:{grid:{drawBorder:!1,display:!1,drawOnChartArea:!1,drawTicks:!1},ticks:{display:!1}}}}}),setCoutUp(r,t.total),d.classList.remove("d-none"),removeSkeletonClasses(n),createTotalTable(e,a,o)}function createTotalTable(t,e,a){var o=document.getElementById("total-table-container");const n=document.getElementById("total-table");n.innerHTML+=`
    ...
    `}function setDatatablePlugin(){new simpleDatatables.DataTable("#datatable-patients")}function setCoutUp(t,e){if(t.setAttribute("countTo",e),t){const a=new CountUp(t,t.getAttribute("countTo"));a.error?console.error(a.error):a.start()}}function initializeTooltips(){const t=[].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]'));t.map(function(t){return new bootstrap.Tooltip(t,{})})}function removeSkeletonClasses(t){t.classList.remove(...skeletonClasses)}function aosInit(){AOS.init({duration:1e3,easing:"ease-in-out",once:!1,mirror:!1})}function getInitialData(){$.ajax({url:"/initial-dashboard-data",type:"GET",success:t=>{var e=t.weekly_ranking,a=t.annual_ranking,o=t.total_ranking,t=t.summary,n=e.start_date+" - "+e.end_date,s=e.data.moderate_patients,l=e.data.serius_patients,r=e.data.critical_patients;setPatientCard(n,s,"moderate"),setPatientCard(n,l,"serius"),setPatientCard(n,r,"critical"),createWeeklyPatientsChart(e,s,l,r),createTotalPatientsDoughnutChart(o),createTotalPatientsLineChart(a),createSummaryTable(t),initializeTooltips()}})}document.querySelector(".datepicker")&&flatpickr(".datepicker",{mode:"range",locale:"es"});